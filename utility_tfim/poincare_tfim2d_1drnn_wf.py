...
class RNNwavefunction(object):
    def __init__(self, systemsize_x, systemsize_y, cell_type, units, r_max=None, seed=111):
...
class RNNwavefunction_hyp(object):
    def __init__(self, systemsize_x, systemsize_y, cell_type, bias_geom, hyp_non_lin, units, r_max,seed=111):
